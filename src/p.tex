...
\begin{example}
  ...
  $p>0$に対し,
  \begin{align*}
    \ell^p=\Set{(a_i)_{i\in\NN}\in \ell(\KK)|\sum_i |a_i|^p < \infty}
  \end{align*}
  とおくと, $\ell^p$は$\ell(\KK)$の部分空間.
  \begin{align*}
    \ell^\infty=\Set{(a_i)_{i\in\NN}\in \ell(\KK)|\sup \Set{\left|a_i\right||i\in \NN} < \infty}
  \end{align*}
  とおくと, $\ell^\infty$は$\ell(\KK)$の部分空間.
  \begin{align*}
    c&=\Set{(a_i)_{i\in\NN} \in \ell(\KK)| \lim_{i\to\infty} a_i \in\KK}\\
    c_0&=\Set{(a_i)_{i\in\NN} \in \ell(\KK)| \lim_{i\to\infty} a_i =0}\\
  \end{align*}
...
\begin{example}
  数列をすべて集めた集合$\ell(\KK)$は$\KK$線形空間であった.
  \begin{align*}
    c_{00}&=\Set{(a_i)_{i\in\NN} \in \ell(\KK) | \#\Set{i| a_i \neq 0} < 0}
  \end{align*}
  とおくと, $c_{00}$は$\ell(\CC)$の部分空間である.
...
\begin{definition}
  ...
  \begin{enumerate}
  \item $\alpha_1\act v_1\plus\cdots\plus \alpha_r\act v_r=\zzero \implies \alpha_1=\cdots=\alpha_r=0$.
  \end{enumerate}
