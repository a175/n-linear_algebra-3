...
\begin{example}
  ...
  $\nu_{(w_1,\ldots,w_r)}$を
    \begin{align*}
      ...
      {\begin{pmatrix}a_1\\\vdots\\a_r\end{pmatrix}}{a_1w_1+\cdots+a_rw_r}
    \end{align*}
    で定義する.
...
これらではなく, $+$などが$W$上の演算であるかということである.
つまり, 以下の$3$条件が重要である.
\begin{enumerate}
  \item $0_V\in W$.
...
\begin{lemma}
  ...
  \item 以下の$2$条件を満たす:
    \begin{enumerate}
  \item $0_V\in W$.
  \item $v,w\in W, a,b\in\KK \implies a\act v+b\act w\in W$.
    \end{enumerate}
  \item 以下の$3$条件を満たす:
    \begin{enumerate}
  \item $W\neq \emptyset$.
...
\begin{prop}
  ...
  \begin{align*}
  v&=a_1\act w_1+\cdots +a_r\act w_r\\
  v'&=a'_1\act w_1+\cdots +a'_r\act w_r\\
  \end{align*}
  とする.
  このとき以下は同値:
  \begin{enumerate}
...
\begin{prop}
  ...
  つまり,
  $v=a_1\act w_1+\ldots+a_r\act w_r$
...
\begin{remark}
  ...
  \begin{align*}
    ...
    c\act [u]_V&=[c\act u]_V=\Set{c\act u \plus v|v\in V}
  \end{align*}
  とする.
\end{remark}
